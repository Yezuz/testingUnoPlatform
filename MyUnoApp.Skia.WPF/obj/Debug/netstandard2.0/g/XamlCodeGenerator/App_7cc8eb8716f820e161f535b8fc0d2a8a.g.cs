...
namespace MyUnoApp
{
	...
	partial class App : Windows.UI.Xaml.Application
	{
				private void InitializeComponent()
		{
			...
			.GenericApply((c0 => 
			{
				// Source /home/jesus/codingExcercises/UnoPlatform/MyUnoApp/MyUnoApp.Shared/App.xaml (Line 1:2)
			...
			global::MyUnoApp.Skia.WPF.GlobalStaticResources.Initialize();
			global::MyUnoApp.Skia.WPF.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::MyUnoApp.Skia.WPF.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::MyUnoApp.Skia.WPF.Resource.Drawable);
			#endif
			// MergedDictionaries
			...
			// Source ../../../../../../MyUnoApp.Shared/App.xaml (Line 1:2)
		}
...
{
	static class App_7cc8eb8716f820e161f535b8fc0d2a8aXamlApplyExtensions
	{
	}
}
